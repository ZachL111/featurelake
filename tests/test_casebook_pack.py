"""Regression checks for the featurelake casebook."""
...
from casebook.harness import assert_expected, featurelake_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(featurelake_summary(), assert_expected())
