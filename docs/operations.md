...
`featurelake` is centered on data engineering work in Python. The technical target is: Maintain typed feature schemas and train-serving parity checks.
...
The score is deterministic. The current threshold is 177. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 4.
