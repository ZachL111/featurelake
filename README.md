...
featurelake is a Python project for data engineering. It focuses on this technical goal: Maintain typed feature schemas and train-serving parity checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 177, risk penalty 5, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
